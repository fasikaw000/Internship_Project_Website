    ...
    <div className="min-h-[calc(100vh-8rem)] bg-[#87CEEB]">
      ...
      >
        <div className="w-full max-w-2xl flex flex-col justify-center items-center px-6 py-12 animate-slideUp">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 drop-shadow-lg scale-100 hover:scale-105 transition-transform duration-500">
          ...
          <Link
            to="/products"
            className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 md:px-10 py-3 md:py-4 rounded-full font-bold shadow-xl transition-all hover:shadow-2xl hover:-translate-y-1 active:scale-95 animate-fadeIn"
          >
            Shop Now
          </Link>
        </div>
