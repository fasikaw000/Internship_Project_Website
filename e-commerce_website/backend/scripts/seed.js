...
const PRODUCTS = [
  ...
  { file: "fashion-1.png", name: "Brown Shearling Jacket", category: "fashion", price: 249.00, description: "Brown teddy fleece jacket with shearling collar, full zip." },
  { file: "fashion-2.png", name: "Light Blue Dress Shirt", category: "fashion", price: 49.99, description: "Classic long-sleeved men's dress shirt in light blue." },
  { file: "fashion-3.png", name: "Platform Sneakers", category: "fashion", price: 79.99, description: "Women's pink and white platform sneakers with metallic accents." },
